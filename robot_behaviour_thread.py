import threading
from ev3dev2.motor import LargeMotor, OUTPUT_A, OUTPUT_B, OUTPUT_C, OUTPUT_D, SpeedPercent, MoveTank, MoveSteering, MediumMotor
...
class RobotBehaviourThread(threading.Thread):
    move_the_claw = MediumMotor(OUTPUT_A)
